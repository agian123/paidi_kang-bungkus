...
echo -e "${Info} Wireguard VPS AutoScript by Paidi"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Paidi-1/paidi_kang-bungkus/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Paidi-1/paidi_kang-bungkus/main/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/Paidi-1/paidi_kang-bungkus/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/Paidi-1/paidi_kang-bungkus/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Paidi-1/paidi_kang-bungkus/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
